namespace ServerUtil
{
    ...
    public class PageCreator
    {
        ...
        {
            string[] readable = Convert.StatusCode(statusCode);

            StringBuilder page = new StringBuilder();

            page.AppendLine("<html>");
            page.AppendLine("<head>");
            page.AppendFormat("<title>Vitesse {0}</title>\n", statusCode);
            page.AppendLine("<link rel=\"icon\" href=\"https://higgy.s3.amazonaws.com/images/v_italic.jpg\" type=\"image/jpeg\">");
            page.AppendLine("<style>");
            page.AppendLine("\timg {width: 30%; margin-left: 450; padding: 0;}");
            page.AppendLine("\th2 {font-family: 'Trebuchet MS serif'; font-size: 24; font-style: italic; margin-left: 450; padding: 0;}");
            page.AppendLine("\tp {font-family: 'Trebuchet MS serif'; font-size: 22; font-style: italic; margin-left: 450; width: 30%; padding: 0;}");
            page.AppendLine("</style>");
            page.AppendLine("</head>");
            page.AppendLine("<body>");
            page.AppendLine("<div>");
            page.AppendFormat("\t<h2>{0} ({1})</h2>\n", statusCode, readable[0]);
            page.AppendLine("\t<img src=\"https://higgy.s3.amazonaws.com/images/v_italic.jpg\">");
            page.AppendFormat("\t<p>{0}</p>\n", readable[1]);
            page.AppendLine("</div>");
            page.AppendLine("</body>");
            page.AppendLine("</html>");
    ...
    public class Convert
    {
        ...
        public static string[] StatusCode(int code)
        {
            if (statusCodes.ContainsKey(code))
                ...
                throw new ArgumentException("Invalid arguments given to ServerUtil.Convert.StatusCode");
        }
    };
}